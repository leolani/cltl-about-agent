...
class AboutService:
    ...
    def from_config(cls, about: About, event_bus: EventBus, resource_manager: ResourceManager,
        ...
        return cls(config.get("topic_input"), config.get("topic_output"), about, event_bus, resource_manager)

    def __init__(self, input_topic: str, output_topic: str, about: About,
    ...
    def start(self, timeout=30):
        ...
        greeting_payload = self._create_payload(self._about.respond(None))
